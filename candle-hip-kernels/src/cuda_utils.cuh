...
__device__ void chunk_sum(
    ...
    int chunk_start = max((int)(block_i - chunk_i), 0);
    int chunk_end = min((int)(block_i + chunk_len - chunk_i), blockDim.x);
...
// #endif
 ...
 __device__ __forceinline__ hip_bfloat16 powg(hip_bfloat16 a, hip_bfloat16 b) { return __float2bfloat16(powf(__bfloat162float(a), __bfloat162float(b))); }
 __device__ __forceinline__ bool isnang(hip_bfloat16 a) { return __hisnan(a); }
 __device__ __forceinline__ hip_bfloat16 sqrtg(hip_bfloat16 a) { return hsqrt(a); }
 __device__ __forceinline__ hip_bfloat16 cosg(hip_bfloat16 a) { return hcos(a); }
 __device__ __forceinline__ hip_bfloat16 sing(hip_bfloat16 a) { return hsin(a); }
 __device__ __forceinline__ hip_bfloat16 recipg(hip_bfloat16 a) { hip_bfloat16 one = 1.0; return one / a; }
 __device__ __forceinline__ hip_bfloat16 maxg(hip_bfloat16 a, hip_bfloat16 b) { return __hmax_nan(a, b); }
 __device__ __forceinline__ hip_bfloat16 tanhg(hip_bfloat16 a) { return __float2bfloat16(tanhf(__bfloat162float(a))); }
 __device__ __forceinline__ hip_bfloat16 erfg(hip_bfloat16 a) { return __float2bfloat16(erff(__bfloat162float(a))); }
 __device__ __forceinline__ hip_bfloat16 ceilg(hip_bfloat16 a) { return __float2bfloat16(ceilf(__bfloat162float(a))); }
 __device__ __forceinline__ hip_bfloat16 floorg(hip_bfloat16 a) { return __float2bfloat16(floorf(__bfloat162float(a))); }
 __device__ __forceinline__ hip_bfloat16 roundg(hip_bfloat16 a) { return __float2bfloat16(roundf(__bfloat162float(a))); }
 __device__ __forceinline__ hip_bfloat16 normcdfg(hip_bfloat16 a) { return __float2bfloat16(normcdff(__bfloat162float(a))); }
 __device__ __forceinline__ hip_bfloat16 ming(hip_bfloat16 a, hip_bfloat16 b) { return __hmin_nan(a, b); }
 __device__ __forceinline__ hip_bfloat16 logg(hip_bfloat16 a) { return hlog(a); }
 __device__ __forceinline__ hip_bfloat16 expg(hip_bfloat16 a) { return hexp(a); }
 __device__ __forceinline__ hip_bfloat16 absg(hip_bfloat16 a) { return __habs(a); }
 __device__ __forceinline__ hip_bfloat16 copysigng(hip_bfloat16 a, hip_bfloat16 b) { return __float2bfloat16(copysignf(__bfloat162float(a), __bfloat162float(b))); }
 #endif
